...
namespace WindowsFormsApp1.Microsoft_Access_База_данныхDataSetTableAdapters {
    ...
    public partial class userTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE `user` SET `Login` = ?, `Password` = ? WHERE ((`ID` = ?) AND ((? = 1 AND `" +
                "Login` IS NULL) OR (`Login` = ?)) AND ((? = 1 AND `Password` IS NULL) OR (`Passw" +
                "ord` = ?)))";
        ...
        public virtual int Fill(Microsoft_Access_База_данныхDataSet.userDataTable dataTable) {
        ...
        public virtual Microsoft_Access_База_данныхDataSet.userDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            Microsoft_Access_База_данныхDataSet.userDataTable dataTable = new Microsoft_Access_База_данныхDataSet.userDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(Microsoft_Access_База_данныхDataSet.userDataTable dataTable) {
